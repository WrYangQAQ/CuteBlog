...
namespace CuteBlogSystem.Migrations
{
    ...
    [Migration("20260724050205_UpdateSourceActionFromUserLongTermMemoriesMaxLength")]
    partial class UpdateSourceActionFromUserLongTermMemoriesMaxLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CuteBlogSystem.Entity.AgentConversationMemory", b =>
                {
                    ...
                    b.Property<string>("RecentMentionedArticlesJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("CuteBlogSystem.Entity.UserLongTermMemory", b =>
                {
                    ...
                    b.HasIndex("Status", "IsPinned", "LastDecayAt");

                    b.HasIndex("UserId", "Status", "Importance")
                        .IsDescending(false, false, true);

                    b.HasIndex("UserId", "MemoryKey", "MemoryGroup", "MemoryType")
                        .IsUnique()
                        .HasFilter("[MemoryKey] IS NOT NULL AND [Status] = 1");

                    b.ToTable("UserLongTermMemories", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserLongTermMemories_AccessCount", "[AccessCount] >= 0");

                            t.HasCheckConstraint("CK_UserLongTermMemories_Confidence", "[Confidence] >= 0 AND [Confidence] <= 1");

                            t.HasCheckConstraint("CK_UserLongTermMemories_Importance", "[Importance] >= 0 AND [Importance] <= 1");

                            t.HasCheckConstraint("CK_UserLongTermMemories_MetadataJson", "[MetadataJson] IS NULL OR ISJSON([MetadataJson]) = 1");

                            t.HasCheckConstraint("CK_UserLongTermMemories_RevisionNo", "[RevisionNo] >= 1");
                        });
                });
            ...
            modelBuilder.Entity("CuteBlogSystem.Entity.UserLongTermMemory", b =>
                {
                    b.HasOne("CuteBlogSystem.Entity.UserLongTermMemory", "SupersedesMemory")
                        .WithMany()
